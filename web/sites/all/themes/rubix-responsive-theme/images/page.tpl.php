  ...
  <div id="inner_header_wrapper">
    ...
    <header id="header" role="banner">
      ...
      <div class="social-icons">
       <ul>
        <li><a href="<?php print $front_page; ?>/rss.xml"><img src="<?php print base_path() . drupal_get_path('theme', 'rubix_responsive_theme') . '/images/rss.png'; ?>" alt="RSS Feed"/></a></li>
        <li><a href="http://www.facebook.com/<?php echo theme_get_setting('facebook_username', 'rubix_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'rubix_responsive_theme') . '/images/icone-facebook.svg'; ?>" alt="Facebook" width="30" height="30"/></a>   </li>
        
        <li><a href="http://www.twitter.com/<?php echo theme_get_setting('twitter_username', 'rubix_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'rubix_responsive_theme') . '/images/icone-twitter.svg'; ?>" alt="Twitter" width="30" height="30"/></a></li>
         <li><a href="http://fr.viadeo.com/fr/profile/master.sippe/<?php echo theme_get_setting('twitter_username', 'rubix_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'rubix_responsive_theme') . '/images/icone-viadeo.svg'; ?>" alt="viadeo"  width="30" height="30"/></a></li>
		 <li><a href="http://fr.linkedin.com/in/mastersippe/<?php echo theme_get_setting('linkedin_username', 'rubix_responsive_theme'); ?>" target="_blank" rel="me"><img src="<?php print base_path() . drupal_get_path('theme', 'rubix_responsive_theme') . '/images/icone-linkedin.svg'; ?>" alt="linkedin" width="30" height="30"/></a></li>
